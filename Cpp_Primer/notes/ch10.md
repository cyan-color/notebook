...
- [第十章 泛型算法](#%E7%AC%AC%E5%8D%81%E7%AB%A0-%E6%B3%9B%E5%9E%8B%E7%AE%97%E6%B3%95)
    - [1. 泛型算法](#1-%E6%B3%9B%E5%9E%8B%E7%AE%97%E6%B3%95)
        - [1.1. find](#11-find)
    - [2. 初识泛型算法](#2-%E5%88%9D%E8%AF%86%E6%B3%9B%E5%9E%8B%E7%AE%97%E6%B3%95)
        - [2.1. 只读算法](#21-%E5%8F%AA%E8%AF%BB%E7%AE%97%E6%B3%95)
        - [2.2. 写容器元素的算法](#22-%E5%86%99%E5%AE%B9%E5%99%A8%E5%85%83%E7%B4%A0%E7%9A%84%E7%AE%97%E6%B3%95)
        - [2.3. 重排容器元素的算法](#23-%E9%87%8D%E6%8E%92%E5%AE%B9%E5%99%A8%E5%85%83%E7%B4%A0%E7%9A%84%E7%AE%97%E6%B3%95)
    - [3. 定制操作](#3-%E5%AE%9A%E5%88%B6%E6%93%8D%E4%BD%9C)
        - [3.1. 向算法传递函数：](#31-%E5%90%91%E7%AE%97%E6%B3%95%E4%BC%A0%E9%80%92%E5%87%BD%E6%95%B0)
        - [3.2. lambda表达式](#32-lambda%E8%A1%A8%E8%BE%BE%E5%BC%8F)
        - [3.3. lambda捕获和返回](#33-lambda%E6%8D%95%E8%8E%B7%E5%92%8C%E8%BF%94%E5%9B%9E)
        - [3.4. 参数绑定](#34-%E5%8F%82%E6%95%B0%E7%BB%91%E5%AE%9A)
    - [4. 再探迭代器](#4-%E5%86%8D%E6%8E%A2%E8%BF%AD%E4%BB%A3%E5%99%A8)
        - [4.1. 插入迭代器](#41-%E6%8F%92%E5%85%A5%E8%BF%AD%E4%BB%A3%E5%99%A8)
        - [4.2. iostream迭代器](#42-iostream%E8%BF%AD%E4%BB%A3%E5%99%A8)
        - [4.3. 反向迭代器](#43-%E5%8F%8D%E5%90%91%E8%BF%AD%E4%BB%A3%E5%99%A8)
    - [5. 泛型算法结构](#5-%E6%B3%9B%E5%9E%8B%E7%AE%97%E6%B3%95%E7%BB%93%E6%9E%84)
        - [5.1. 类迭代器](#51-%E7%B1%BB%E8%BF%AD%E4%BB%A3%E5%99%A8)
        - [5.2. 算法的形参模式](#52-%E7%AE%97%E6%B3%95%E7%9A%84%E5%BD%A2%E5%8F%82%E6%A8%A1%E5%BC%8F)
        - [5.3. 算法命名规范](#53-%E7%AE%97%E6%B3%95%E5%91%BD%E5%90%8D%E8%A7%84%E8%8C%83)
    - [6. 特定容器算法](#6-%E7%89%B9%E5%AE%9A%E5%AE%B9%E5%99%A8%E7%AE%97%E6%B3%95)
...
```cpp
// 第三个参数决定了返回类型，以及+的使用
std::string sum = std::accumulate(v.cbegin(),v.cend(),std::string("")); // 正确
std::string sum = std::accumulate(v.cbegin(),v.cend(),""); // 错误：const char*没有定义+运算符
```
### 写容器元素的算法
...
- `copy`时**必须保证目标目的序列至少要包含与输入序列一样多的元素**。
```cpp
vector<int> vec;
...
std::fill_n(vec.begin(), 10, std::back_inserter(vec));
...
auto end_unique = std::unique(word.begin(), word.end());
...
- 标准库`bind`函数：
  ...
  - `auto g = std::bind(f, a, b, _2, c, _1);`，调用`g(_1, _2)`实际上调用`f(a, b, _2, c, _1)`
  - 非占位符的参数要使用引用传参，必须使用标准库`std::ref`函数或者`std::cref`函数。
  - 成员函数的包装
    - 静态成员函数和普通的函数基本一样，在用法上也没有很大的差异；
    - 绑定成员函数时，函数名参数后面需要紧跟着类的对象作为参数
