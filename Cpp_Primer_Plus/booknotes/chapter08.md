...
- [第八章 函数探幽](#%E7%AC%AC%E5%85%AB%E7%AB%A0-%E5%87%BD%E6%95%B0%E6%8E%A2%E5%B9%BD)
    - [1. C++ 内联函数](#1-c-%E5%86%85%E8%81%94%E5%87%BD%E6%95%B0)
    - [2. 引用变量](#2-%E5%BC%95%E7%94%A8%E5%8F%98%E9%87%8F)
        - [2.1. 创建引用变量](#21-%E5%88%9B%E5%BB%BA%E5%BC%95%E7%94%A8%E5%8F%98%E9%87%8F)
        - [2.2. 将引用用作函数参数](#22-%E5%B0%86%E5%BC%95%E7%94%A8%E7%94%A8%E4%BD%9C%E5%87%BD%E6%95%B0%E5%8F%82%E6%95%B0)
        - [2.3. 引用的属性和特别之处](#23-%E5%BC%95%E7%94%A8%E7%9A%84%E5%B1%9E%E6%80%A7%E5%92%8C%E7%89%B9%E5%88%AB%E4%B9%8B%E5%A4%84)
        - [2.4. 将引用用于结构体](#24-%E5%B0%86%E5%BC%95%E7%94%A8%E7%94%A8%E4%BA%8E%E7%BB%93%E6%9E%84%E4%BD%93)
        - [2.5. 将引用用于类对象](#25-%E5%B0%86%E5%BC%95%E7%94%A8%E7%94%A8%E4%BA%8E%E7%B1%BB%E5%AF%B9%E8%B1%A1)
        - [2.6. 对象、继承和引用](#26-%E5%AF%B9%E8%B1%A1%E7%BB%A7%E6%89%BF%E5%92%8C%E5%BC%95%E7%94%A8)
        - [2.7. 何时使用引用参数](#27-%E4%BD%95%E6%97%B6%E4%BD%BF%E7%94%A8%E5%BC%95%E7%94%A8%E5%8F%82%E6%95%B0)
    - [3. 默认参数](#3-%E9%BB%98%E8%AE%A4%E5%8F%82%E6%95%B0)
    - [4. 函数重载](#4-%E5%87%BD%E6%95%B0%E9%87%8D%E8%BD%BD)
        - [4.1. 函数重载示例](#41-%E5%87%BD%E6%95%B0%E9%87%8D%E8%BD%BD%E7%A4%BA%E4%BE%8B)
        - [4.2. 何时使用函数重载](#42-%E4%BD%95%E6%97%B6%E4%BD%BF%E7%94%A8%E5%87%BD%E6%95%B0%E9%87%8D%E8%BD%BD)
    - [5. 函数模板](#5-%E5%87%BD%E6%95%B0%E6%A8%A1%E6%9D%BF)
        - [5.1. 模板的局限](#51-%E6%A8%A1%E6%9D%BF%E7%9A%84%E5%B1%80%E9%99%90)
        - [5.2. 显式具体化](#52-%E6%98%BE%E5%BC%8F%E5%85%B7%E4%BD%93%E5%8C%96)
        - [5.3. 实例化和具体化](#53-%E5%AE%9E%E4%BE%8B%E5%8C%96%E5%92%8C%E5%85%B7%E4%BD%93%E5%8C%96)
        - [5.4. 编译器选择使用哪个函数版本](#54-%E7%BC%96%E8%AF%91%E5%99%A8%E9%80%89%E6%8B%A9%E4%BD%BF%E7%94%A8%E5%93%AA%E4%B8%AA%E5%87%BD%E6%95%B0%E7%89%88%E6%9C%AC)
        - [5.5. 模板函数的发展](#55-%E6%A8%A1%E6%9D%BF%E5%87%BD%E6%95%B0%E7%9A%84%E5%8F%91%E5%B1%95)
...
**该函数返回一个指向临时变量（newguy）的引用，函数运行完毕后 它将不再存在。同样，也应避免返回指向临时变量的指针。**
...
char * left(const char * str, int n = 1); // 声明

// This function returns a pointer to a new string
// consisting of the first n characters in the str string.
char * left(const char * str, int n)      // 定义
{
    if(n < 0)
        n = 0;
    char * p = new char[n+1];
...
请记住，**是特征标(即，函数特征列表)，而不是函数返回类型使得可以对函数进行重载**。 例如，下面的两个声明是互斥的：
...
> 由于C++允许将一个结构赋给另一个结构，因此即使T是一个`job`结构，上述代码也适用。然而，假设只想交换 `salary` 和 `floor` 成员，而不交换 `name` 成员，则需要使用不同的代码，但 `Swap()` 的参数将保持不变 （两个 `job` 结构的引用），因此无法使用模板重载来提供其他的代码。
...
// swap just the salary and floor fields of job structure
template <> void swap<job>(job &, job &){
    double t1;
    int t2;
    t1 = j1.salary;
...
函数调用`Swap(i,j`)导致编译器生成`Swap()`的一个实例，该实例使用`int`类型。**模板并非函数定义，但使用int的模板实例是函数定义**。这种实例化方式被称为隐式实例化（implicit instantiation），因为编译器之所以知道需要进行定义，是由于程序调用Swap()函数时提供了int参数。

最初，编译器只能通过隐式实例化，来使用模板生成函数定义，但现在C++还允许显式实例化（explicit instantiation）。这意味着可以直接命令编译器创建特定的实例，如`Swap<int>()`。其语法是，声明所需的种类——用`<>`符号指示类型，并在声明前加上关键字 `template`：
...
int main(){
    // explicit instantiation for the char type
    template void swap<char>(char &, char &);

    short a, b;
    swap(a, b); // implicit instantiation for the short type

    job n, m;
    swap(n, m); // use explicit specialization for the job type

    char g, h;
    swap(g, h); // use explicit instantiation for the char type
}
```
